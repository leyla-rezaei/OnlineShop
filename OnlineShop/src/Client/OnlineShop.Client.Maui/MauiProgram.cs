...
using OnlineShop.Client.Maui.Services;
...
namespace OnlineShop.Client.Maui;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseMauiApp<App>()
            .UseAppStoreInfo()
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "OnlineShop.Client.Maui");
        ...
        mauiApp.Services.GetRequiredService<PubSubService>()
            .Subscribe(ClientPubSubMessages.PAGE_DATA_CHANGED, async (args) =>
            {
                ...
                {
                    Application.Current!.Windows.First().Title = title ?? "OnlineShop";
                });
            });
