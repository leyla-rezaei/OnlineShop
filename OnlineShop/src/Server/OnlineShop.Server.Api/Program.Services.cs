...
using OnlineShop.Server.Api.Controllers;
using OnlineShop.Server.Shared.Services;
using OnlineShop.Server.Api.Services.Jobs;
using OnlineShop.Server.Api.Models.Identity;
using OnlineShop.Server.Api.Services.Identity;
...
public static partial class Program
{
    public static void AddServerApiProjectServices(this WebApplicationBuilder builder)
    {
        ...
        services.AddScoped(sp =>
        {
            ...
            var options = new Fido2Configuration
            {
                ...
                ServerName = "OnlineShop WebAuthn",
        ...
        builder.Services.AddHangfire(configuration =>
        {
            var efCoreStorage = configuration.UseEFCoreStorage(optionsBuilder =>
            {
                ...
                {
                    var connectionString = "Data Source=OnlineShopJobs.db;Mode=Memory;Cache=Shared;";
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "OnlineShop.Server.Api.xml"), includeControllerXmlComments: true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "OnlineShop.Shared.xml"));
