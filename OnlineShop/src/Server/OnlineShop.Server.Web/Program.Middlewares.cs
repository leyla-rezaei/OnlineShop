...
using OnlineShop.Shared.Attributes;
using Hangfire;
using OnlineShop.Server.Api;
using OnlineShop.Server.Api.Filters;
using OnlineShop.Server.Api.Services;
using OnlineShop.Server.Web.Endpoints;
...
public static partial class Program
{
    ...
    public static void ConfigureMiddlewares(this WebApplication app)
    {
        ...
        {
            options.InjectJavascript($"/_content/OnlineShop.Server.Api/scripts/swagger-utils.js?v={Environment.TickCount64}");
        });
        ...
        var blazorApp = app.MapRazorComponents<Components.App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("OnlineShop.Client") is true).ToArray());
