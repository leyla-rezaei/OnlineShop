...
namespace OnlineShop.Server.Web.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShop.Client.Core");
        ...
        // but uses ../../Client/OnlineShop.Client.Web:../../Client/OnlineShop.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShop.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/OnlineShop.Client.Maui/Components:../../Client/OnlineShop.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShop.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/OnlineShop.Client.Windows/Components:../../Client/OnlineShop.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/OnlineShop.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/OnlineShop.Client.Web/Components:../../Client/OnlineShop.Client.Web/Components");
